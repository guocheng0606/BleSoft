...
public class Ble<T extends BleDevice> {
   ...
   /*  public Class<T> getDeviceClass(){
    ...
    public static class Options {
        ...
        UUID uuid_service = UUID.fromString("0003cdd0-0000-1000-8000-00805f9b0131");
        UUID uuid_write_cha = UUID.fromString("0003cdd2-0000-1000-8000-00805f9b0131");
        UUID uuid_read_cha = UUID.fromString("0003cdd2-0000-1000-8000-00805f9b0131");
        UUID uuid_notify = UUID.fromString("0003cdd1-0000-1000-8000-00805f9b0131");
        UUID uuid_notify_desc = UUID.fromString("0003cdd0-0000-1000-8000-00805f9b0131");
